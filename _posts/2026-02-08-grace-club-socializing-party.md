...
categories: [social]
image: /images/blog/shinchon-socializing-1.png
author: wonder
---
...
![신촌 노고산 스튜디오 입구](/images/blog/shinchon-socializing-2.png)
...
![파티 장소 내부 — 앤티크 샹들리에와 스텐딩 테이블](/images/blog/shinchon-socializing-3.png)
...
![이차 — 송리단길 라운지의 디저트](/images/blog/shinchon-socializing-4.png)
...
심지어 내 차키의 키링이 리사이클업된 검정 네잎클로버 모양의 키링인데, 그걸 궁금해해주고, 폰에 NFC 태그해서 오늘의 명언도 같이 읽어주고.

내 차에 있는 디퓨저 향기도 알아봐주고. 밤쉘, 다니엘 트루스.

차 모니터에 걸어둔 라이언·어피치 방향제, 그리고 춘식이 폰번호 거치대.
